...
$mdp2 = "auto";
$start_time = microtime(true);
$retour = verificationMdp($mdp2);
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo "il faudra " .  round($execution_time, 4) . " secondes pour trouver le mot de passe: " . $mdp2 . "<br>";

$mdp3 = "a2c3x";
$start_time = microtime(true);
$retour = verificationMdp($mdp3);
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo "il faudra " .  round($execution_time, 4) . " secondes pour trouver le mot de passe: " . $mdp3 . "<br>";
